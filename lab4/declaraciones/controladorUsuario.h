...
class ControladorUsuario {
    ...
    public:
        ...
        std::list<DTComentario> listarComentario(std::string nombreU);
        ...
        DTCompra confirmarCompra(std::map <int,int > productos, double &monto,std::string cliente,DTFecha fechaActual);
        ...
        int getIdCompra(std::string cliente, DTFecha fecha, int idProducto);
};
